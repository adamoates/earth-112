                ...
                <div className="rounded-lg border bg-card p-6 shadow-sm">
                    ...
                    <div className="mb-6">
                        <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                            <div className="text-center">
                                <h3 className="mb-2 text-sm font-medium text-gray-900 dark:text-gray-100">Quick Sign Up</h3>
                                <p className="mb-4 text-xs text-gray-600 dark:text-gray-400">Create your account with Google</p>
                                <a
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-card px-2 text-gray-500 dark:text-gray-400">Or create with email</span>
                        </div>
                    </div>
